# Klasifikasi dan Prediksi Indeks Pemberdayaan Gender (IDG) Indonesia
...
- Proyeksi tahun berikutnya dapat menjadi early warning bagi wilayah yang berpotensi mengalami penurunan IDG.
...
- Studi kasus penerapan klasifikasi dan regresi pada data deret waktu (time-series) singkat berbasis wilayah, termasuk bagaimana menghindari data leakage dan melakukan validasi proyeksi.

## Dataset

Dataset berisi nilai Indeks Pemberdayaan Gender (IDG) untuk ratusan kabupaten/kota di Indonesia pada tahun 2021, 2022, dan 2023, bersumber dari data resmi (BPS).
...
4. **Exploratory Data Analysis (EDA)** - correlation heatmap antar tahun dan distribusi nilai IDG
...
- Proyeksi nilai IDG 2024 divalidasi terlebih dahulu menggunakan data historis yang sudah diketahui (2023), sehingga tingkat kepercayaan proyeksi (RMSE 4.75 poin) dapat dipertanggungjawabkan, bukan sekadar angka tanpa dasar.
- Wilayah dengan IDG terendah relatif konsisten dari tahun ke tahun, menunjukkan bahwa kesenjangan pemberdayaan gender di wilayah tersebut bersifat struktural dan memerlukan intervensi berkelanjutan, bukan sekadar kebijakan jangka pendek.
